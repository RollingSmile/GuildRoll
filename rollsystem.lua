...
-- Give to Member dialog and remaining helper functions...
-- (The rest of the file continues as above; unchanged.)
...
-- Central event handler and rest of implementation already included above.
